...
public class MediaController {
     ...
     */
    @PostMapping("/upload/bulkMedia")
    public ResponseEntity<CommonResponse> uploadBulkImage(@RequestParam("file") List<MultipartFile> files) {
            CommonResponse commonResponse = mediaService.uploadBulkImage(files);
            return new ResponseEntity<>(commonResponse, HttpStatus.OK);
    }
